...
export const AboutMe = () => {
  return (
    ...
    >
      <h2 className=' top-0 text-3xl md:text-5xl text-cyan-300 mb-4 absolute left-4 md:top-20'>
        UN POCO SOBRE MI----🚀
      </h2>
      <div className='  max-w-lg p-4'>
        <p className='md:max-w-md text-stone-300 '>
          Hola, soy <Marker>Franciso Merce</Marker> soy un desarrollador Frontend,
          autodidacta desde los 17 años, me gusta mucho el mundo de la programacion y
          el desarrollo web en especial, en 2021 decidi dar el paso de ingresar a un
